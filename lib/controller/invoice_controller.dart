...
class InvoiceController extends GetxController {
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
                  ...
                  pw.Row(
                    children: [
                      ...
                      pw.Text(
                        ...
                        style: pw.TextStyle(fontSize: 30, fontStyle: pw.FontStyle.italic,letterSpacing: 2),
                      ),
                      pw.SizedBox(width: 4),
                      pw.Container(
                        width: 100,
              ...
              leftTextWithRightBigText("NO:",titleCodeController.text.toUpperCase(),pw.MainAxisAlignment.end),
              ...
              leftTextWithRightBigText("Date:",dateEnteringController.text,pw.MainAxisAlignment.end),
              ...
              leftTextWithRightBigTextModify("Bank",noteInfoController.text,pw.MainAxisAlignment.start),
              pw.SizedBox(height: 10),
              leftTextWithRightBigTextModify("Acc No",termsConditionsController.text,pw.MainAxisAlignment.start),
              pw.SizedBox(height: 10),
              leftTextWithRightBigTextModify("Email",bankEmailController.text,pw.MainAxisAlignment.start),
            pw.Row(
            // crossAxisAlignment: pw.CrossAxisAlignment.end,
              ...
              iconTextRow(mobileToController.text, emailToController.text,billToController.text)
            ],
          );
        },
      ),
  ...
  pw.Widget drawerHeader(pw.Context context) {
    return pw.Row(
      children: [pw.Positioned(
        ...
        // child: pw.Expanded(
        //   child: pw.Container(  // Separating border
        //     decoration: pw.BoxDecoration(
        //       border: pw.Border(left: pw.BorderSide(width: 1, color: PdfColors.grey)),
        //     ),
        //   ),
        // ),
      ),
  ...
  pw.Widget leftTextWithRightBigText(String boldTitle,String normalTitle,pw.MainAxisAlignment mainAxisAlignment,) {
    return pw.Row(
  ...
  pw.Widget leftTextWithRightBigTextModify(String boldTitle,String normalTitle,pw.MainAxisAlignment mainAxisAlignment,) {
    return pw.Row(
      mainAxisAlignment: mainAxisAlignment,
      ...
      child: pw.Table(
        ...
        children: <pw.TableRow>[
          ...
          pw.TableRow(
            children: <pw.Widget>[
              for (var header in ['Description', 'Qty', 'Price', 'Total'])
                pw.Container(
                  decoration: const pw.BoxDecoration(color: PdfColors.orangeAccent), // Set header cell background color
          ...
          for (var i = 0; i < tableData.length; i++)
            pw.TableRow(
              decoration: i == tableData.length - 1 ? const pw.BoxDecoration(color: PdfColors.orangeAccent) : null,
              children: <pw.Widget>[

                for (var j = 0; j < tableData[i].length; j++)
                  pw.Container(
                    padding: const pw.EdgeInsets.all(10),
                    decoration: (j != 2 && i == tableData.length - 1) ? const pw.BoxDecoration(color: PdfColors.orangeAccent) : null,
                    child: pw.Text(
                      tableData[i][j],
                      style: pw.TextStyle(
                        color: (tableData[i][j] == discountController.text || tableData[i][j] == subtotalController.text) ? PdfColors.black : PdfColors.black,
                      ),
                    ),
                  ),
              ],
  ...
  pw.Widget iconTextRow(
    ...
    return pw.Row(
      children: [
        pw.Text("📞", style: pw.TextStyle(fontFallback: [emoji],color: PdfColors.orange50)),
        pw.SizedBox(width: 5),
        pw.Text(phoneNumber,style: pw.TextStyle(
            fontStyle: pw.FontStyle.normal,
            fontSize: 12,
            color: PdfColors.grey700),),
        ...
        pw.Text("📩", style: pw.TextStyle(fontFallback: [emoji],color: PdfColors.orange50)),
        pw.SizedBox(width: 5),
        pw.Text(emailAddress,style: pw.TextStyle(
            fontStyle: pw.FontStyle.normal,
            fontSize: 12,
            color: PdfColors.grey700),),
        pw.SizedBox(width: 20),
        pw.Text("📌", style: pw.TextStyle(fontFallback: [emoji],color: PdfColors.orange50)),
        pw.SizedBox(width: 5),
        pw.Text(locationAddress,style: pw.TextStyle(
            fontStyle: pw.FontStyle.normal,
            fontSize: 12,
            color: PdfColors.grey700),),
      ],
